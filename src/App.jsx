...
// import LandingPage from './components/LandingPage'; // Preserved — re-enable when public site is ready
...
export default function App() {
  ...
  // Login screen — all content is behind auth for now
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm text-center">
        <div className="mb-8">
          <div className="text-5xl mb-4">🚢</div>
          <h1 className="text-2xl font-bold text-white mb-1">Adam The Cruise Guy</h1>
